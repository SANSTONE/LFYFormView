...
-(void)addTableView{
    ...
    tableView.separatorColor        = [UIColor colorWithRed:93.0/255.0 green:93.0/255.0 blue:93.0/255.0 alpha:1];
...
-(void)addSubmitButton{
    ...
    // setup
    [submitButton setBackgroundColor:[UIColor colorWithRed:0.0/255.0 green:200.0/255.0 blue:175.0/255.0 alpha:1]];
